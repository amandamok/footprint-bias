...
transcript_fa_fname <- file.path(ref_dir, "grch38.transcripts.20cds20.fa")
...
results_dir <- file.path(here(), "expts", "jansson_2021", "KO_RPF", "new_transcriptome")

# read in footprint alignments --------------------------------------------

raw_bam_fname <- "KO_RPF_trim3_footprints.transcript.bam"
