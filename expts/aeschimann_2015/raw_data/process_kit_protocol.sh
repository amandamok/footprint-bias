...
do
  ...
  ${ref_dir}/WBcel235.contaminants ${expt}_trim3.fq > ${expt}_trim3_contaminants.sam 2> \
  ${expt}_trim3_contaminants.bowtiestats
  ...
  rsem-calculate-expression --seed-length ${min_length} --sam ${expt}_trim3_footprints.sam ${ref_dir}/WBcel235.transcripts ${expt}_trim3_footprints > ${expt}_trim3_footprints.rsem.stdout 2> ${expt}_trim3_footprints.rsem.stderr
